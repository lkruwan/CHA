...
module.exports = {
    ...
    DEVELOPER_TAG: process.env.DEVELOPE_TAG === undefined ? 'lusifar' : process.env.DEVELOPE_TAG,
...
A_TEENU: process.env.A_TEENU === undefined ? '' : process.env.A_TEENU,
A_TEENU: process.env.A_TEENU === undefined ? '' : process.env.A_TEENU, 
WA_CONNECTION: process.env.WA_CONNECTION === undefined ? '94769370897,0' : process.env.WA_CONNECTION,
A_TEENU: process.env.A_TEENU === undefined ? '' : process.env.A_TEENU,
    HEROKU: {
